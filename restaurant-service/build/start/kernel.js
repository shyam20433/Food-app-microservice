...
Server_1.default.middleware.registerNamed({
    jwtAuth: () => Promise.resolve().then(() => __importStar(global[Symbol.for('ioc.use')]('App/Middleware/JwtAuth'))),
    role: () => Promise.resolve().then(() => __importStar(global[Symbol.for('ioc.use')]('App/Middleware/RoleMiddleware'))),
});
