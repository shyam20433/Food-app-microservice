...
class UpdateMenuItemValidator {
    constructor(ctx) {
        this.ctx = ctx;
        this.schema = Validator_1.schema.create({
            category_id: Validator_1.schema.string.optional({ trim: true }, [Validator_1.rules.uuid()]),
            ...
            price: Validator_1.schema.number.optional([Validator_1.rules.range(0.01, 100000)]),
...
exports.default = UpdateMenuItemValidator;
//# sourceMappingURL=UpdateMenuItemValidator.js.map